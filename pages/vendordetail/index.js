      ...
      <div className="vendor_detail">
        ...
        <div className="vendor_detail_body">
          <div className="vendor_image">
            <img src={vendorimage.src} alt="vendor_image"></img>
          </div>
          ...
          <div className="vendor_all_images_container">
            <div className="vendor_single_image_container">
              {" "}
              <img src={thegrandream.src} alt="the_grand_dream" />
            </div>
            <div className="vendor_single_image_container">
              {" "}
              <img src={granddream.src} alt="granddream" />
            </div>
            <div className="vendor_single_image_container">
              {" "}
              <img src={starland.src} alt="starland" />
            </div>
            <div className="vendor_single_image_container">
              {" "}
              <img src={william.src} alt="william" />
            </div>
          ...
          <div className="vendor_overview">
            <p className="vendor_overview_heading">Overview</p>
            <p className="vendor_overview_desc">
